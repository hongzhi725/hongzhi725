...
function lettersinit() {
	...
	var b = [
		['1.热爱生活，乐观自信；<br />2.有扎实的文字功底，具有良好的语言和文字表达能力；<br />3.有较高的文学鉴赏能力和有良好的传统文学和艺术修养；<br />4.有清晰的逻辑思维清晰，良好的沟通能力；<br />5.学习能力与理解力强；<br />6.有创新意识，对生活环境有敏锐的感知能力。<br />具备以下能力者优先：<br />1.文案写作与文字编辑能力；<br />2.创作文章能力；<br />3.专业：新闻传播/新闻评论/编辑出版学/中国文学/汉语言文学/中文文秘/心理学等相关文科专业；<br />4.在公关传播、市场活动、广告等方面具有文案策划实施经验，有优秀作品或出版作品者优先。<br /><br />★投递通道：lixiaojuan@bluemoon.com.cn'],
		['1.具有敏锐的洞察能力和新事物接收与传播能力；<br />2.较强的文字功底和编辑能力，思维活跃；<br />3.熟悉互联网语言和文化，对互联网营销有一定的理解；<br />4.拥有互联网公关营销工作经验，或成功网络、微信、微博推广经验，口碑营销、主题营销、视频营销活动策划成功案例者优先考虑。<br /><br />★投递通道：lixiaojuan@bluemoon.com.cn'],
		...
		['1.本科以上学历，人力资源相关专业优先；<br />2.2年以上人事相关的工作，掌握基础的人员评估方法，人际敏感度高，有一定的人员识别能力；<br />3.心态乐观、开放、不计较，学习意愿强，自我要求较高；<br />4.承压力较好，应变性及灵活性较好；<br />5.客户导向意识强，具备一定的思考改善意识；<br />6.沟通协调能力较好，有团队管理经验，对人力资源各模块工作比较熟悉。<br/><br/>★投递通道：chijieyun@bluemoon.com.cn'],
		['1.素质能力需求：<br />① 有承压能力，正面积极的心态面对问题<br />② 理解能力较好，善于倾听，可以准确理解对方意思<br />③ 逻辑思维好，思考问题和做事情要有一定的条理性<br />④ 客户导向，有换位思考的习惯，乐意为业务部门服务<br />⑤ 改善意识，愿意学习进步，改变自己的不好习惯<br />2.专业需求（加分项，非否决项）：<br />① 最好有一定的excel和PPT的技术<br />② 学过平衡计分卡或者战略地图为佳<br/><br/>★投递通道：chijieyun@bluemoon.com.cn'],
		['1.全日制本科以上学历，人力资源管理、会计等相关专业；<br />2.一年以上薪酬、绩效相关经验（手工核算经验）；<br />3.善于对数据进行分析，工作认真细致，保密意识强；<br />4.能熟练使用办公软件，尤其EXCEL函数；<br />5.具备的沟通表达能力好，逻辑性及抗压能力强。<br/><br/>★投递通道：chijieyun@bluemoon.com.cn'],
		['1.全日制本科及以上学历，专业不限； <br />2.3年及以上招聘工作经验； <br />3.人际敏感度高，有一定的人员识别能力； <br />4.愿意想办法解决问题，有良好的服务意识与团队合作能力； <br />5.善于沟通表达，逻辑条理清晰，有一定的灵活性； <br />6.责任心强，主动意识好。<br/><br/>★投递通道：wujieying@bluemoon.com.cn'],
		['1.本科及以上学历，计算机及相关专业，有过一年以上java开发经验；<br />2.熟悉分布式集群服务，有dubbo、zookeeper、redis使用经验优先<br />3.熟悉通用数据库；<br />4.熟悉面向对象分析、设计，能独自完成模块开发；<br />5.具有较强的分析组织能力、逻辑判断能力；<br />6.有过电商平台、微信平台、APP手机平台相关项目开发经验优先。<br/><br/>★投递通道：jiangzhanneng@bluemoon.com.cn'],
		...
		['1.熟练运用C/C++/C#，熟悉Windows平台软件的开发或熟悉面向对象编程；<br />2.具有丰富的Visual C++ / Visual C++.NET 或Win32 SDK / MFC编程经验； <br />3.熟悉USB、RS232/RS485、了解RFID者优先；<br />4.了解USB摄像机、IP摄像机开发接入者优先；<br />5.具有良好的开发文档撰写能力。<br/><br/>★投递通道：jiangzhanneng@bluemoon.com.cn'],
		['1.本科及以上学历，数学、统计学或计算机相关专业，3年以上系统设计工作经验；<br />2.熟悉数据仓库及大数据类项目的开发流程及系统架构， 对系统中各部分的工具及技术要有一定的了解；<br />3.熟练掌握主流数据库系统中的一种或多种，例如Oracle、DB2、GreenPlum、SQL Server，有ETL或SQL开发经验；<br />4.对虚拟化技术、云计算、MapReduce、Hadoop等相关原理及技术有相关基础；<br />5.懂得使用spss modeler,R等数据挖掘工具优先；<br />6.优秀的沟通表达、团队协作及项目管理能力，强烈的责任感，抗压能力强。<br/><br/>★投递通道：jiangzhanneng@bluemoon.com.cn'],
		['1.计算机相关专业本科及以上学历，2年以上编程经验，熟悉hadoop原理、熟悉hadoop集群的搭建、管理及优化；<br />2.熟悉HDFS/HBase/Hive/MapReduce，有丰富的分布式编程及海量数据处理经验；<br />3.熟悉Core Java, 熟悉Java IO, NIO, 多线程编程. 熟悉JVM运行机制和内存管理, 网络协议；<br />4.熟练掌握Linux操作系统，熟悉shell等脚本编程；<br />5.熟悉storm、kafka、spark streaming等CEP流式计算技术优先；<br />6.责任心强，认真细致，良好的沟通能力和团队协作精神，有清晰的逻辑思维能力。<br/><br/>★投递通道：jiangzhanneng@bluemoon.com.cn'],
		['1.本科或以上学历，2年或以上工作经验；<br />2.热爱技术研究，逻辑理解能力强；<br />3.对面向对象程序设计有比较清晰的理解，有一定的系统设计经验；<br />4.能熟练使用Java语言，对Java ee体系有比较广泛的接触和了解，熟悉Oracle、MySQL、PostgreSQL等主流数据库及SQL编程； <br />5.熟悉HTML，JavaScript，AJAX等前端技术，有数据可视化开发经验者优先；<br />6.责任心强，认真细致，良好的沟通能力和团队协作精神，有清晰的逻辑思维能力。<br/><br/>★投递通道：jiangzhanneng@bluemoon.com.cn'],
