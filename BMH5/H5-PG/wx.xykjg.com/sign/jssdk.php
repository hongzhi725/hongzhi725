...
//		$location_id="";
    ...
    $nonceStr = $this->createNonceStr();
		...
		$arrdata = array("api_ticket" => $apiTicket,"app_id" => $this->appid,"card_id" => $card_id,"code" => $code,"card_type" => $card_type,"location_id" => $location_id,"noncestr" => $noncestr,"timestamp" => $timestamp );
