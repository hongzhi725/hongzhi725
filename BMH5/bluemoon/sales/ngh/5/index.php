...
<html>
	<head>
		...
		<meta name="keywords" content="蓝月亮,市场部,销售部,内购会,负责人：罗善芳,对接人：胡红俐" />
	...
	<body>
		...
		<div class="container">
			<div class="ngh" data-scroll-reveal="enter top and move 50px over 0.3s">
				...
				<div class="title1">活动时间：10月14日-10月16日</div>
				<div class="title2">活动地址：江阴 · 华地百货城中大统华</div>
			</div>
		...
		<script type="text/javascript">
			...
			wx.ready(function() {
				...
				wx.onMenuShareAppMessage({
					title: '蓝月亮超值内购会', // 分享标题
					desc: '蓝月亮超值内购会\n活动地址：江阴 · 华地百货城中大统华', // 分享描述
					link: 'http://wx.xykjg.com/sales/ngh/5/', // 分享链接
					imgUrl: 'http://wx.xykjg.com/sales/ngh/5/img/share.png', // 分享图标
