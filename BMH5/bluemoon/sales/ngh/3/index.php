...
<html>
	<head>
		...
		<meta name="keywords" content="蓝月亮,市场部,销售部,内购会,负责人：周梦,对接人：胡红俐" />
	...
	<body>
		...
		<div class="container">
			<div class="ngh" data-scroll-reveal="enter top and move 50px over 0.3s">
				...
				<div class="title1">活动时间：10月24日-10月31日</div>
				<div class="title2">活动地址：苏州 · 苏杭时代渭塘店</div>
			</div>
		...
		<script type="text/javascript">
			...
			wx.ready(function() {
				...
				wx.onMenuShareAppMessage({
					title: '蓝月亮超值内购会', // 分享标题
					desc: '蓝月亮超值内购会\n活动地址：苏州 · 苏杭时代渭塘店', // 分享描述
					link: 'http://wx.xykjg.com/sales/ngh/3/', // 分享链接
					imgUrl: 'http://wx.xykjg.com/sales/ngh/3/img/share.png', // 分享图标
