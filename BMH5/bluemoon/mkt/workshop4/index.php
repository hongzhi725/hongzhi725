			...
			<div class="swiper-container">
				<div class="swiper-wrapper">
					<div class="swiper-slide slide1" style="display: block;">
						...
						<div class="word3 ani" swiper-animate-effect="fadeInRight" swiper-animate-duration="1s" swiper-animate-delay="2.5s">会议日期：2016年10月13日</div>
		...
		<script type="text/javascript">
			...
			wx.ready(function() {
				...
				wx.onMenuShareAppMessage({
					...
					link: 'http://wx.xykjg.com/mkt/workshop4/', // 分享链接
